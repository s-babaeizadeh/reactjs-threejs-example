...
//2. Camera
const camera = new THREE.PerspectiveCamera(75, aspect:window.innerWidth / window.innerHeight, near:0.1, far:1000);
camera.position.z =5 
...
// 5. Renderer
const renderer = new THREE.WebGL3DRenderTarget(parameters:{canvas});
